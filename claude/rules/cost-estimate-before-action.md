...
> On-demand rule — don't import into `CLAUDE.md`; skills/agent should `Read` this file before triggering one of the actions below. Same content as [`cursor/rules/cost-estimate-before-action.mdc`](../../cursor/rules/cost-estimate-before-action.mdc).
