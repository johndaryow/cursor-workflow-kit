...
Read [`cost-estimate-before-action.md`](../../../docs/rules/cost-estimate-before-action.md). Plain-English estimate + CEO OK for bulk DB, always-on Functions, large AI batches.
