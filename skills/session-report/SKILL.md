...
Follow [`session-report-format.md`](../../../docs/rules/reporting.md). **`Slice:` must be a machine id** (`CM3`, `CDRIVE-7`, `W18`) so the chain can advance — except planning PRs (`Slice: FM PRD planning`).

## Assurance paragraph

Same voice as [`ceo-communication.md`](../../../AGENTS.md) — sacrifice grammar, outcome first:
